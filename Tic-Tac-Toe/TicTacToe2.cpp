    ...
    */
    ...
    while (true) {
        ...
        if (mode == 0) {
            ...
            throw "get_input() @para mode error";
...
void welcome_message() {
    ...
    cout << "|/_/ /_/\\___/    /_/  \\__,_/\\___/    /_/  \\____/\\___/ |"
         << endl;
    cout << "|                                                     |" << endl;
    cout << "|-----------------------------------------------------|" << endl;
}
...
void rule_message() {
    ...
    if (ai_active) {
        cout << "|-----------------------------------------------------|"
             << endl;
        cout << "| >You choose to against the AI                       |"
             << endl;
        cout << "|                                                     |"
             << endl;
        cout << "|  Throw a dice and the bigger one play first         |"
             << endl;
        cout << "|  (use O as chessman)                                |"
             << endl;
        cout << "|                                                     |"
             << endl;
        cout << "|  press any button to throw a dice                   |"
             << endl;
        cout << "|-----------------------------------------------------|"
             << endl;
    } else {
        cout << "|-----------------------------------------------------|"
             << endl;
        cout << "| >You'll against each other                          |"
             << endl;
        cout << "|                                                     |"
             << endl;
        cout << "|  Player 1 and Player 2, you both will throw a dice  |"
             << endl;
        cout << "|  the bigger one play first (use O as chessman)      |"
             << endl;
        cout << "|                                                     |"
             << endl;
        cout << "|  press any button to throw a dice                   |"
...
void goodbye_message() {
    ...
    cout << "|     \\____/\\____/\\____/\\__,_/_.___/\\__, /\\___/       |"
         << endl;
    cout << "|                                  /____/             |" << endl;
    cout << "+-----------------------------------------------------+" << endl;
}
...
void roll_a_dice() {
    /* This function ask the users to roll a dice to decide the game order (PvP
     * only). */
...
bool check_state() {
    /*
    This function update game state and return false if game has ended, else
    true. State List      1:  X WIN 2:  O WIN 3:  DRAW 4:  O's turn (default) 5:
    X's turn
    */
    ...
    for (int i = 0; i < 8; i++) {
        ...
        if (cells[s1] != -1 && cells[s1] == cells[s2] &&
            cells[s2] == cells[s3]) {
            winner = cells[s1];
            state = (winner == 1) ? 1 : 2;
            break;
...
void showboard() {
    ...
    for (int i = 0; i < 5; i++) {
        cout << "|                     "; // whitespace number: (55 - 11) / 2 =
                                          // 22
        if (i % 2 == 1) {
            cout << "---+---+---"
                 << "                     |" << endl;
...
void update_screen() {
    /* This function update the screen while gaming, show new game state and
     * gameboard. */
...
bool is_full() {
    /* This function return a bool value indicating whether the gameboard is
     * full. */
...
int minimax(int depth, bool isMax) {
    ...
    if (score == 20)
        return score - depth; // if ai win
    if (score == -20)
        return score + depth; // if player win
    if (is_full())
        return 0; // if draw
